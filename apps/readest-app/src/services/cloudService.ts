...
export async function deleteBook(
  ...
  if (deleteAction === 'local' || deleteAction === 'both' || deleteAction === 'purge') {
    ...
    // Purge erases the entire app-generated Books/<hash>/ directory, including
    // the managed book, cover, reading progress and navigation cache.
    // In-place books keep their external
